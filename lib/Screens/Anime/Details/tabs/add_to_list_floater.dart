                    ...
                    anilistAuthController.userData.value.name != null
                        ? Expanded(
                            child: Container(
                              ...
                              child: addButtonText(context, "Add to list"),
                            ),
                          )
          ...
          return AzyXGradientContainer(
              ...
              child: ListView(
                children: [
                  ...
                  Obx(() => offlineController.categories.value.isEmpty
                      ? const SizedBox.shrink()
                      : Column(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      ...
                                      isSelected.value
                                          ? offlineController.addItem(
                                              data, i.name!)
                                          : offlineController.removeItem(
                                              data, i.name!);
                                    },
                                    child: SizedBox(
                                      width: 18,
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () {
                        offlineController
                            .addNewCategory(textEditingController.text);
