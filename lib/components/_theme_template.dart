...
class ThemeTemplate extends StatelessWidget {
  ...
  const ThemeTemplate({super.key, required this.topLeft, required this.bottomLeft, required this.bottomRight, required this.topRight});
              ...
              Column(
                children: [
                  Container(
                    height: 60,
                    width: 43,
                    decoration:  BoxDecoration(borderRadius: BorderRadius.only(topLeft: Radius.circular(20)), color: topLeft),
                  ),
                  Container(
                    height: 90,
                    width: 43,
                    decoration:  BoxDecoration(borderRadius: BorderRadius.only(bottomLeft: Radius.circular(20)), color:bottomLeft),
                  ),
                ],
              ),
              Column(
