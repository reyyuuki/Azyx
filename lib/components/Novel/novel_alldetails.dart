    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          NovelInfo(novelData: novelData,),
          const SizedBox(
            height: 10,
          ),
          Text(novelData['description'].length > 380 ? '${novelData['description'].substring(0,380)}...' : novelData['description'], style: const TextStyle(fontStyle: FontStyle.italic, color: Color.fromARGB(232, 165, 159, 159)),),
        ],
      ),
    );
  }
