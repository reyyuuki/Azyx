...
class AllMangaLists extends StatelessWidget {
  final List<dynamic> data;

  const AllMangaLists({super.key, required this.data});
              ...
              itemBuilder: (context, index) {
                ...
                return Column(
                  children: [
                    ...
                    const SizedBox(height: 5),
                    Text(
                        '${data[index]['progress'].toString()} | ${data[index]['media']['chapters'] == null ? 0 : data[index]['media']['chapters'].toString()}')
                  ],
                );
              },
            )
