  ...
  Widget build(BuildContext context) {
    ...
    return SliderTheme(
      ...
      child: Slider(
        ...
        onChanged: isLocked == true ? null : onChanged,
        onChangeStart: isLocked == true ? null : onDragStart,
        onChangeEnd: isLocked == true ? null : onDragEnd,
        min: min,
        max: max,
        divisions: divisions,
        label: indiactorTime ?? indicatorTime ?? value.toStringAsFixed(1),
      ),
    );
  }
}
